...
const Home = () => {
  return (
    <div>
      {/* Header */}
      <header>
        <div className="logo">Job Seek</div>
        <nav>
  ...
  backgroundImage: "url('https://png.pngtree.com/thumb_back/fh260/background/20190221/ourmid/pngtree-simple-e-commerce-jobs-cooperation-image_21195.jpg')",
  ...
  <h1 style={{ fontSize: "3rem", marginBottom: "10px", textShadow: "1px 1px 5px #000" }}>
    ...
    <br></br>
     Search and apply for thousands of jobs internationally.
  </h1>
  <p style={{ 
    fontSize: "1.2rem", 
    marginBottom: "130px", 
    ...
    {[
      ...
      <footer>
        ...
        <div className="footer-bottom">
          <p>&copy; 2025 Job Seek. All rights reserved. | Connecting talent with opportunity globally.</p>
        </div>
      </footer>
    </div>
  );
